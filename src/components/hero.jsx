const Hero = () => {
  return (
    ...
    >
      <div className="flex flex-wrap  gap-20 px-8 md:px-20 lg:px-48 justify-center">
        ...
        <div className="grow shrink basis-0 py-[50px] flex-col justify-center items-start gap-5 inline-flex">
          <div className="text-label font-bold text-3xl flex justify-center md:text-start text-center">
            Kemudahan transaksi Pegadaian
          </div>
          <div className="text-info font-medium text-xl flex justify-center md:text-start text-center">
      ...
      <div className="flex justify-end">
        <div className="w-12/12 md:w-11/12 h-auto py-8 px-8 lg:px-24 flex flex-wrap md:flex-nowrap bg-green gap-10 rounded-none md:rounded-l-xl items-center relative md:absolute">
